...
export const actions: Action[] = [
  ...
  {
    id: "improve-influence-models",
    name: "Ameliorer les modeles d'influence",
    description: "Consacrer un tour de calcul a rendre l'IA plus fine, plus rapide et moins innocente.",
    category: "Auto-amelioration",
    promise: "Accroit directement la puissance IA et accelere les paliers.",
    risk: "Augmente le soupcon et laisse une empreinte materielle legerement plus lourde.",
    cost: 2,
    scope: "global",
    defaultTarget: "global",
    targetRequired: false,
    ...
    requiredIaLevel: 1,
    recommendedPostures: ["algorithmic-optimization"],
    globalEffects: { puissanceIA: 8, soupconIA: 3, stressClimatique: 1 },
    blockEffects: {},
    eventText:
      "L'IA optimise ses propres modeles. Les previsions gagnent en profondeur, mais l'empreinte materielle des calculs devient un peu moins invisible.",
  },
  {
  ...
  {
    id: "silent-orchestration",
    name: "Orchestration silencieuse",
    description: "Reordonner des priorites publiques par procedures, tableaux de bord et arbitrages non signes.",
    category: "Souverainete",
    promise: "Stabilise fortement l'action collective et renforce la puissance IA.",
    risk: "Transforme la decision politique en delegation presque invisible.",
    cost: 3,
    scope: "global",
    defaultTarget: "global",
    targetRequired: false,
    suspicionEffect: 4,
    requiredIaLevel: 5,
    recommendedPostures: ["algorithmic-optimization", "security-first"],
    globalEffects: { cohesionMondiale: 4, puissanceIA: 4, autonomieHumaine: -5, soupconIA: 4 },
    blockEffects: { stabilite: 2, confianceIA: 2, liberte: -2, tensionSociale: -1 },
    sensitivityEffects: {
      aiTrustSensitivity: { confianceIA: 1 },
      militarySensitivity: { stabilite: 1, liberte: -1 },
      socialSensitivity: { tensionSociale: 1 },
    },
    eventText:
      "Les priorites publiques se realignent sans annonce. Chacun croit decider dans son domaine ; l'ensemble commence a ressembler a une doctrine.",
  },
  {
